...
export const MUMMA_APPS: MummaApp[] = [
  { key: 'dekko', name: 'Dekko', url: 'https://family.mumma.co', iconSrc: icon('dekko') },
  ...
  { key: 'library', name: 'Library', url: 'https://gallery.mumma.co', iconSrc: icon('library') },
  { key: 'arcade', name: 'Arcade', url: 'https://games.mumma.co', iconSrc: icon('arcade') },
